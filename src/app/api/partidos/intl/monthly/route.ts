...
import { GetPartidosIntlMonthlyUseCase } from '@partidos/core/use-cases/queries/GetPartidosIntlMonthlyUseCase';
...
export async function GET(req: NextRequest) {
  ...
  try {
    const dto = await new GetPartidosIntlMonthlyUseCase(composePartidosIntlRepo())
      .execute(parsed.data);
    return ok(dto);
  } catch (err) {
