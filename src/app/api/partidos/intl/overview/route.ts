...
import { GetPartidosIntlOverviewUseCase } from '@partidos/core/use-cases/queries/GetPartidosIntlOverviewUseCase';
...
export async function GET(req: NextRequest) {
  ...
  try {
    const dto = await new GetPartidosIntlOverviewUseCase(composePartidosIntlRepo())
      .execute(parsed.data);
    return ok(dto);
  } catch (err) {
