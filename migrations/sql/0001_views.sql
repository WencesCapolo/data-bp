...
-- ============================================================================
-- basket_mat_gateway_net_daily and basket_mat_gateway_net_outside_pagos live in
-- migrations/sql/0020_gateway_net_pago_anchored.sql. They read the fee mirror
-- AND basket_v_active_payments (the DROP ... CASCADE above takes them down), so
-- `pnpm views:apply` re-applies 0019 and 0020 after this file.
-- ============================================================================
